// ---------------------------------------------------------------------------
// Default Shopify product_type → SpatialAble category_path mappings
//
// Seeded into shopify_taxonomy_map table. Grows per client as new
// product types are encountered and mapped by operators.
// ---------------------------------------------------------------------------

export const DEFAULT_TAXONOMY: Array<{
  shopify_type: string;
